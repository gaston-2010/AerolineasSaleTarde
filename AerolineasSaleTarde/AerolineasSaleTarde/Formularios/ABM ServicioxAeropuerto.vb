Public Class ABM_ServicioxAeropuerto
    ...
    Private Sub cmd_Buscar_Click(sender As Object, e As EventArgs) Handles cmd_Buscar.Click
        ...
        Else
          ...
          JOIN TipoServicio t ON s.tipo_servicio = t.id  where a.nombre=" & cmb_Aeropuerto.SelectedText
    ...
    Public Function comprobarexistencia()
        ...
        Dim sql As String = "SELECT s.id_aeropuerto,s.tipo_servicio,s.nombre FROM ServicioxAeropuerto s join Aeropuertos a on s.id_aeropuerto = a.id
            where s.id_aeropuerto =" & cmb_Aeropuerto.SelectedValue & " AND s.tipo_servicio=" & cmb_tipoServicio.SelectedValue & " AND s.nombre= '" & txt_nombreservicio.Text & "'"
